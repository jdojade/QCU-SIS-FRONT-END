...
// redirect from schedule pickup to Good Moral (Good Moral)
function schedgpupRedirect() {
    window.location.assign('admin-gmoral.html');
 }


 // redirect from counsel to schedule counseling (Counselling)
function counselRedirect() {
    window.location.assign('admin-schedCounsel.html');
 }
